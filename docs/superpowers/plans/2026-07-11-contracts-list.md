# Contract List Screen Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement the redesigned "Hợp đồng" screen according to user screenshots.
...
- Register this screen in `App.tsx` replacing the generic screen for route `hop-dong`.
...
- [ ] **Step 1: Import `ContractsList` screen in `App.tsx`**
