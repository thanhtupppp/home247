 ...
 */
async function executeTool(name, args, ownerId) {
    try {
        switch (name) {
            case 'get_overdue_invoices': {
                const invoices = await (0, firestore_1.getLandlordInvoices)(ownerId);
            ...
            case 'get_expiring_contracts': {
                const contracts = await (0, firestore_1.getLandlordContracts)(ownerId);
            ...
            case 'get_open_support_requests': {
                const requests = await (0, firestore_1.getLandlordSupportRequests)(ownerId);
            ...
            case 'get_buildings_and_rooms': {
                const buildings = await (0, firestore_1.getLandlordBuildings)(ownerId);
                const rooms = await (0, firestore_1.getLandlordRooms)(ownerId);
                return {
